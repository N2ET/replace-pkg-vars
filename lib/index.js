...
function registerFilter (files, defaultFiles) {
    ...
    handlebars.registerHelper('filter', filterFn);
    handlebars.registerHelper('count', function countFn() {
        let ret = filterFn.apply(this, arguments);
