 ...
 */
function run (data, pkgFile, writeToFile = true) {

    pkgFile = pkgFile || './package.json';

    let content = readFile(pkgFile);

    let result = runWithTemplate(data, content);
 ...
 */
function runWithTemplate (data, content) {
